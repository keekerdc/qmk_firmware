 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LCTL | LALT |  CMD | / BKSP  /       \ Spac \  |RAISE | RALT | RCTL  |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_EQL,  KC_MINS,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT, \
                             KC_LCTL, KC_LALT, KC_LGUI,KC_BSPC,   KC_SPC,  RAISE,   KC_RALT, KC_RCTL \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |  `   |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 * |      |      |      |      |      |      |                    |      |      |  Up  |      |      |   ]  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |-------.    ,-------|      | Left | Down | Rght |      |      |
 * |------+------+------+------+------+------|   -   |    |   =   |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT( \
  ...
  _______,   KC_F5,   KC_F6,   KC_F7,   KC_F8, _______,                     _______, _______, KC_UP,   _______, _______, KC_RBRC, \
  _______,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,                       XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, XXXXXXX, \
